(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 23755, (e, t, r) => {
    "use strict";
    ...
    function l(e, t) {
        for (let [r, l] of Object.entries(t)) {
            ...
            "SCRIPT" === e.tagName && a(u) ? e[u] = !!l : e.setAttribute(u, String(l)), (!1 === l || "SCRIPT" === e.tagName && a(u) && (!l || "false" === l)) && (e.setAttribute(u, ""), e.removeAttribute(u))
        }
    }("function" == typeof r.default || "object" == typeof r.default && null !== r.default) && void 0 === r.default.__esModule && (Object.defineProperty(r.default, "__esModule", {
        value: !0
    }), Object.assign(r.default, r), t.exports = r.default)
    ...
    Object.defineProperty(r, "__esModule", {
        value: !0
    }), e.r(66849), ("function" == typeof r.default || "object" == typeof r.default && null !== r.default) && void 0 === r.default.__esModule && (Object.defineProperty(r.default, "__esModule", {
        value: !0
    }), Object.assign(r.default, r), t.exports = r.default)
}, 51323, (e, t, r) => {
    "use strict";
    ...
    function f(e, t) {
        ...
        (0, u.isBailoutToCSRError)(e) || (0, l.isNextRouterError)(e) || c.originConsoleError(e)
    }

    function p(e) {
        (0, u.isBailoutToCSRError)(e) || (0, l.isNextRouterError)(e) || (0, i.reportGlobalError)(e)
    }("function" == typeof r.default || "object" == typeof r.default && null !== r.default) && void 0 === r.default.__esModule && (Object.defineProperty(r.default, "__esModule", {
        value: !0
    }), Object.assign(r.default, r), t.exports = r.default)
}, 62634, (e, t, r) => {
    ...
    function l({
        ...
        let [u, i] = (0, n.useState)(""), d = (0, n.useRef)(void 0);
    ...
    function a(e, t) {
        return function e(t, r, a, l) {
            ...
            "children" in r && u.unshift("children");
            let i = t.slots;
            if (null !== i)
                for (let t of u) {
                    let [l, u] = r[t];
                    ...
                    let d = i[t];
                    if (!d) continue;
                    let s = e(d, u, a + "/" + (0, o.createRouterCacheKey)(l), a + "/" + (0, o.createRouterCacheKey)(l, !0));
                    if (s) return s
                }
            return null
        }(e, t, "", "")
    ...
    let a = n._(e.r(41624)),
        l = e.r(72383),
        u = e.r(82604),
        i = "u" > typeof window && (0, u.isBot)(window.navigator.userAgent);
    ...
    function C({
        ...
        (0, l.useEffect)(() => {
            ...
            function e(e) {
                ...
                if ((0, j.isRedirectError)(t)) {
                    e.preventDefault();
                    let r = (0, w.getURLFromRedirectError)(t);
                    "push" === (0, w.getRedirectTypeFromError)(t) ? g.publicAppRouterInstance.push(r, {}): g.publicAppRouterInstance.replace(r, {})
                }
            }
        ...
        if (S.mpaNavigation) {
            ...
            let n = e => {
                if (e.state) {
                    ...
                    (0, l.startTransition)(() => {
                        (0, g.dispatchTraverseAction)(window.location.href, e.state.__PRIVATE_NEXTJS_INTERNALS_TREE)
                    })
                }
            };
        ...
        let {
            ...
            focusAndScrollRef: D,
            previousNextUrl: U
        } = d, F = (0, l.useMemo)(() => (0, _.findHeadInCache)(N, L[1]), [N, L]), H = (0, l.useMemo)(() => (0, v.getSelectedParams)(L), [L]), B = (0, l.useMemo)(() => ({
            parentTree: L,
            parentCacheNode: N,
        ...
        return k = (0, a.jsx)(R.default, {
            ...
            children: [(0, a.jsx)(T, {
                appRouterState: d
            }), null, (0, a.jsx)(s.NavigationPromisesContext.Provider, {
                value: null,
                        ...
                        children: (0, a.jsx)(s.SearchParamsContext.Provider, {
                            ...
                            children: (0, a.jsx)(u.GlobalLayoutRouterContext.Provider, {
                                ...
                                children: (0, a.jsx)(u.AppRouterContext.Provider, {
                                    value: g.publicAppRouterInstance,
    ...
    function f({
        ...
        }, M = (0, u.convertRootFlightRouterStateToRouteTree)(R, y, T), A = T.metadataVaryPath, C = (0, l.createInitialCacheNodeForHydration)(e, M, S, O, (0, d.computeDynamicStaleAt)(e, j ?? d.UnknownDynamicStaleTime));
        if (null !== p && null !== A) {
            if ((0, c.discoverKnownRoute)(Date.now(), p.pathname, null, null, M, A, b, x, m, !1), null !== S && void 0 !== v)
                if (void 0 !== E && null != r)(0, s.decodeStaticStage)(r, E, void 0).then(async e => {
                    let t = Date.now(),
                        r = await (0, u.getStaleAt)(t, e.s);
                    (0, u.writeStaticStageResponseIntoCache)(t, e.f, void 0, e.h, r, R, y, !0)
                }).catch(() => {});
                else {
                    let e = Date.now();
                    (0, u.getStaleAt)(e, v).then(t => {
                        (0, u.writeStaticStageResponseIntoCache)(e, _, void 0, g, t, R, y, !1)
                    }).catch(() => {}), r ?.cancel()
                }
            else r ?.cancel();
            null != w && (0, u.processRuntimePrefetchStream)(Date.now(), w, R, y).then(e => {
                null !== e && (0, u.writeDynamicRenderResponseIntoCache)(Date.now(), i.FetchStrategy.PPRRuntime, e.flightDatas, e.buildId, e.isResponsePartial, e.headVaryParams, e.staleAt, e.navigationSeed, null)
            }).catch(() => {})
        }
        return {
            tree: C.route,
    ...
    async function H(e, t) {
        let r, n, a = await o;
        a.b ? (0, w.setNavigationBuildId)(a.b) : (0, w.setNavigationBuildId)((0, g.getDeploymentId)());
        let l = Date.now(),
            u = (0, b.createMutableActionQueue)((0, v.createInitialRouterState)({
                navigatedAt: l,
                initialRSCPayload: a,
        ...
        "__next_error__" === document.documentElement.id ? d.default.createRoot(R, F).render(c) : s.default.startTransition(() => {
            d.default.hydrateRoot(R, c, { ...F,
                formState: M
            })
        })
    }("function" == typeof r.default || "object" == typeof r.default && null !== r.default) && void 0 === r.default.__esModule && (Object.defineProperty(r.default, "__esModule", {
